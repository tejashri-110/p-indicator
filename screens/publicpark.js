        ...
        return (
            <ImageBackground source={require('../assets/slot.png')} style={styles.container}>
                ...
                <View style={styles.rowContainer}>
                    ...
                    <TouchableOpacity style={buttonStyle7} disabled={this.state.slot11} onPress={this.Slot11}><Text style={styles.buttonText}>Slot 11</Text></TouchableOpacity>

                    <TouchableOpacity style={buttonStyle8} disabled={this.state.slot12} onPress={this.Slot12}><Text style={styles.buttonText}>Slot 12</Text></TouchableOpacity>

                </View>

                <View style={styles.rowContainer}>

                    <TouchableOpacity style={buttonStyle9} disabled={this.state.slot13} onPress={this.Slot13}><Text style={styles.buttonText}>Slot 13</Text></TouchableOpacity>

                    <TouchableOpacity style={buttonStyleten} disabled={this.state.slot14} onPress={this.Slot14}><Text style={styles.buttonText}>Slot 14</Text></TouchableOpacity>

                </View>
                <View style={styles.rowContainer}>
                    <TouchableOpacity style={buttonStyleten} disabled={true}><Text style={styles.buttonText}>Entry Gate</Text></TouchableOpacity>
                </View>
                <Text style={selectText1} >
